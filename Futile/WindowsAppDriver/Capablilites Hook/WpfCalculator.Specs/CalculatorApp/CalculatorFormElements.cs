...
namespace WpfCalculator.Specs.CalculatorApp;
...
public class CalculatorFormElements {
  ...
  public WindowsElement CommandlineArgumentsLabel =>
      _appDriver.Current.FindElementByAccessibilityId("label_CommandlineArgs");
